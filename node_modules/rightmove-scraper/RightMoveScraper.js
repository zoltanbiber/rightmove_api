...
module.exports = {
  byOutcode:function(outcode, page){
    return JSON.parse(request('GET', "http://api.rightmove.co.uk/api/sale/find?index=0&sortType=6&numberOfPropertiesRequested=10&locationIdentifier=OUTCODE%5E"+(outcodes[outcode]||outcode)+"&apiApplication=IPAD").getBody()).properties;
  },
  detail:function(id){
